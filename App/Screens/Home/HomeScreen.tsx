...
import AppAddExpanseButton from '../../Components/AppAddExpanseButton/AppAddExpanseButton';
...
const HomeScreen = () => {
  ...
  return (
    <View style={styles.mainView}>
      ...
      <TouchableOpacity style={styles.AddButton} onPress={() => navigation.navigate('ExpanseScreen')}>
